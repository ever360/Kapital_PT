              ...
              content: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Saldo Deudor: ${_formatDinero(_saldoPendienteActual)}",
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      onChanged: (val) =>
                          setStateDialog(() => metodoSeleccionado = val!),
                      decoration: InputDecoration(
                        labelText: 'Método',
                        labelStyle: TextStyle(
                          color: isDark ? Colors.white54 : Colors.black54,
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (montoRaw > _saldoPendienteActual) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('El abono es mayor a la deuda!'),
                        ),
                      );
                      return;
                    }
                    ...
                    try {
                      ...
                      final double nuevoSaldo =
                          _saldoPendienteActual - montoRaw;
                      final String nuevoEstado = nuevoSaldo <= 0
                          ? 'PAGADO'
                          : 'ACTIVO';
                  ...
                  child: _pagosList.isEmpty
                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final quienCobro = p['perfiles'] != null
                                ? p['perfiles']['nombre']
                                : 'Desconocido';
                            ...
                            return ListTile(
                              leading: CircleAvatar(
                                backgroundColor: esTransferencia
